import { Mail, Key, Shield, EyeOff, ArrowRight, Lock } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-16 md:mb-20 space-y-4">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-medium text-foreground leading-tight">
            A door that only opens <br className="hidden sm:block" />
            <span className="text-primary italic">for who you choose</span>
          </h2>
          <p className="text-lg md:text-xl text-muted font-light max-w-2xl mx-auto leading-relaxed">
            Your memento is invisible until your guest proves they belong.
            No content renders before they pass the gate.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="bg-background rounded-[2rem] border border-border p-8 md:p-10 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-muted font-light leading-relaxed">
                Set a single password for your memento. Anyone with the link
                and the password can see it. Simple, personal, effective.
              </p>
            </div>
            <div className="bg-secondary/40 rounded-xl p-4 border border-border/50">
              ...
              <div className="space-y-3">
                <div className="w-full h-10 bg-background rounded-lg border border-border flex items-center px-4">
                  <span className="text-sm text-muted/60">Enter password</span>
                </div>
          ...
          <div className="bg-background rounded-[2rem] border border-border p-8 md:p-10 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-muted font-light leading-relaxed">
                Create a list of approved emails. Only those whose email is on
                the whitelist can access the memento. Everyone else sees the
                gate.
              </p>
            </div>
            <div className="bg-secondary/40 rounded-xl p-4 border border-border/50">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-muted/40 text-[10px] uppercase tracking-wider">
                  ...
                  <span>Check if you have access</span>
                </div>
                <div className="flex items-center gap-2 pt-1">
                  <Shield className="w-3 h-3 text-muted/40" />
                  <span className="text-[10px] text-muted/40 uppercase tracking-wider">
                    Only approved emails pass through
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 md:mt-16 text-center max-w-lg mx-auto">
          <div className="flex items-start gap-3 bg-primary/5 rounded-2xl p-5 border border-primary/10">
            ...
            <p className="text-muted text-sm font-light leading-relaxed">
              <span className="font-medium text-foreground">No content leaks.</span>{" "}
              Unlike a private YouTube link or a hidden Instagram account,
              unauthenticated visitors see absolutely nothing — not even a
              preview.
            </p>
          </div>
        </div>
